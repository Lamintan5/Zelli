...
class _ItemReqTntState extends State<ItemReqTnt> {
  ...
  Widget build(BuildContext context) {
    ...
    final reverse = Theme.of(context).brightness == Brightness.dark
        ? Colors.white
        : Colors.black;
    final bold = TextStyle(fontWeight: FontWeight.w700,fontSize: 13,color: reverse);
                                    ...
                                    unitmodel.tid == null
                                        ...
                                        child: Container(
                                            ...
                                            decoration: BoxDecoration(
                                                color:unitmodel.tid == currentUser.uid ? Colors.orange.withOpacity(0.2) : unitmodel.tid != ""? Colors.red.withOpacity(0.2) :Colors.lightBlueAccent.withOpacity(0.2),
                                                borderRadius: BorderRadius.circular(5)
                                            ),
                                            child: Text("Tenant", style: TextStyle(color: unitmodel.tid == currentUser.uid ? Colors.orange : unitmodel.tid != ""? Colors.red : CupertinoColors.activeBlue, fontWeight: FontWeight.w700),)
                                        )
                                    )
                                  ]
                              ) : TextSpan(
